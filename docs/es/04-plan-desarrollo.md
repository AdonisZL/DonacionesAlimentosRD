...
- Consulta PostGIS por radio configurable; reglas de capacidad y cadena de frío.
- Justificación IA (Gemini) **simulada**; confirmación manual; reasignación; notificaciones.
- **Verificación**: sugerir emparejamiento, confirmarlo manualmente.
