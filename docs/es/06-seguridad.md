...
- AES-256 y cédulas: en texto claro pero protegidos por AES-256 + cifrado de disco (TDE) + acceso controlado con RBAC de mínimo privilegio.; no se exponen sin autorización.
