  ...
  return (
    <footer className="bg-on-surface text-surface-bright">
      <div className="max-w-6xl mx-auto px-margin-mobile md:px-margin-desktop py-2xl flex flex-col gap-xl">
        <div className="flex flex-col md:flex-row justify-between gap-xl border-b border-surface-variant/20 pb-xl">
          ...
          <div className="grid grid-cols-2 gap-xl">
            <div className="space-y-sm">
              <p className="font-label-sm text-label-sm uppercase tracking-widest text-surface-variant/60">
                Plataforma
              </p>
              <ul className="space-y-xs font-body-md text-body-md text-surface-variant/80">
                <li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-md">
          <p className="font-body-md text-label-sm text-surface-variant/60">
            © 2026 DonacionesRD · República Dominicana. Proyecto de tesis.
          </p>
          <div className="flex gap-md text-surface-variant/70">
